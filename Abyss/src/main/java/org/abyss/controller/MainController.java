...
public class MainController implements Initializable {
	...
	public void dragDetected(MouseEvent event) { // Je commence à transporter la carte
		...
		int number = Integer.parseInt(String.valueOf(source.charAt(source.length() - 1))); // Je prend le dernier élément de l'ID que je convertis en String puis en int
	...
	public void dragEntered(DragEvent event) { // Je montre à l'utilisateur sur quelle case il s'apprête à poser la carte
